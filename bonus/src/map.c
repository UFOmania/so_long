...
/*   Updated: 2025/02/03 15:10:00 by massrayb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	map_validate_path(t_game_manager *gm, t_elements *elm, int x, int y)
{
	...
	else if (gm->map[y][x] == 'C')
	{
		...
		gm->map[y][x] = 't';
	map_validate_path(gm, elm, x + 1, y);
	map_validate_path(gm, elm, x - 1, y);
	map_validate_path(gm, elm, x, y + 1);
	map_validate_path(gm, elm, x, y - 1);
}
